...
def main():
    ...
    <div class="hero-section">
        ...
        <h4>AI-Powered Oil Spill Detection System :) </h4>
                <br>
        <p style="font-family:Poppins,sans-serif;font-style:italic;font-weight:300;font-size:1.2rem;color:#ffffff;"> <b>AI-Powered</b> Eyes Safeguarding Our <b>Precious Oceans</b> ⚡ </p>
        <p class="subtitle">
